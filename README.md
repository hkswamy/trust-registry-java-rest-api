...
- [Setup and Running Instructions](#setup-and-running-instructions)
    - [1. Set Up Hyperledger Fabric Network](#1-set-up-hyperledger-fabric-network)
    - [2. Deploy the Trust Registry Chaincode](#2-deploy-the-trust-registry-chaincode)
    - [3. Configure the Spring Boot Application](#3-configure-the-spring-boot-application)
    - [4. Build and Run the Spring Boot Application](#4-build-and-run-the-spring-boot-application)
- [API Usage (with Postman)](#api-usage-with-postman)
    - [Importing Postman Collection](#importing-postman-collection)
    - [Using Pre-request Scripts for IDs and Timestamps](#using-pre-request-scripts-for-ids-and-timestamps)
    - [Endpoints Overview](#endpoints-overview)
- [Performance Testing with Locust](#performance-testing-with-locust)
    - [Locust Prerequisites](#locust-prerequisites)
    - [Writing the Locustfile](#writing-the-locustfile)
    - [Running a Locust Test](#running-a-locust-test)
- [API Testing with Streamlit](#api-testing-with-streamlit)
    - [Streamlit Prerequisites](#streamlit-prerequisites)
